...
protected:
    ...
    QAbstractBarSeries::BarsType m_barsType = QAbstractBarSeries::BarsGroups;
    QAbstractBarSeries::BarsOrientation m_barsOrientation = QAbstractBarSeries::BarsVertical;
